...
const Thumbnail = ({ activeState }) => {
  ...
  const backgroundProps = {
    width:
      background.style === "image" && background.bg && patternImage
      ...
      <Stage width={THUMBNAIL_WIDTH} height={THUMBNAIL_HEIGHT}>
        <Layer>
          ...
          >
            ...
            {/* Path 3 - Main QR pattern (truncated for readability) */}
            <Path
            ...
            {/* Path 4 - Another QR pattern section */}
            <Path
