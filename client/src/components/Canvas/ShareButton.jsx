        ...
        <div className="absolute bottom-13 right-0 mb-2 bg-[var(--bg-main)] border border-[var(--border-color)] rounded-lg shadow-lg w-[350px] max-w-[90vw]">
          ...
          <div
            ...
            style={{
              ...
              padding: `${thumbnailWidth / 10}px`,
            }}
          >
            <span
              className="absolute bg-pink w-fit h-fit text-center justify-center items-center flex flex-col rubik font-extrabold leading-none"
              style={{
                fontSize: `${thumbnailHeight * 0.1}px`,
                color: `${activeState?.qr.borderColor}`,
                top: `${thumbnailWidth / 12.5}px`,
                left: `${thumbnailWidth / 10}px`,
                gap: `${thumbnailHeight / 20}px`,
              }}
            >
              MADE WITH
              <svg
                width={`${thumbnailHeight / 2}px`}
            ...
            <div
              ...
              alt="Qreation"
              className="absolute outline outline-black bg-pink-400"
              style={{
                width: `${phoneWidth}px`,
