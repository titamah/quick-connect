    ...
    <div className="relative w-[100vw] h-full">
      ...
      >
        <div
          id="side-panel"
          ref={panelRef}
          className={`fixed  ${isMobile ? "hidden" : ""}  [--body-scroll:true] transition-[left] duration-350 transform h-[calc(100vh-52px)] z-100 bg-[var(--bg-main)] shadow-[0_0_10px_0_rgba(0,0,0,0.075)]`}
          style={{
      ...
      > */}
                  <div
            id="bottom-panel"
            className={`fixed bottom-0 left-0 right-0 ${!isMobile ? "hidden" : ""} transition-[bottom] duration-350 transform z-100 bg-[var(--bg-main)] shadow-[0_0_10px_0_rgba(0,0,0,0.075)]`}
          style={{
